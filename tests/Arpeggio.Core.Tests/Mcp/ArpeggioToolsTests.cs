...
namespace Arpeggio.Core.Tests.Mcp
{
    ...
    {
        /// <summary>既存名と追加名が string 戻り値で公開され、構造化出力を指定しない。</summary>
        [Fact]
        public void ExposesAllToolNamesWithoutStructuredContent()
        {
            string[] expectedNames =
            {
                ...
                "analyze_song", "analyze_wav", "new_sfx", "sfx_presets", "import_wav_sample", "export_ogg", "snes_presets", "export_nsf", "export_vgm", "import_midi",
                "create_sfx", "sfx_parameter_presets", "sfx_parameters", "tweak_sfx", "randomize_sfx", "mutate_sfx", "regenerate_sfx", "detach_sfx"
            };
